<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<div id="top" style="border:0px solid #000; " class="mx-auto"> 
	...
	<map name="GNB">
		...
		<area shape="rect" alt="" title="" coords="428,0,529,33" href="../space/sub01_list.jsp?boardname=admin" target="" />
		<area shape="rect" alt="" title="" coords="536,0,638,33" href="../community/SubList.do?boardname=community&command=list" target="" />
		<area shape="rect" alt="" title="" coords="641,0,749,33" href="../community/SubList.do?boardname=volunteer&command=list" target="" />
	</map>
