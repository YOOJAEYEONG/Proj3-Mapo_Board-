...
<%@ include file="../include/global_head.jsp" %>
	...
	<div id="wrap" align="center">
		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<p style="text-align:center; margin-bottom:20px;"><label><input type="checkbox" id="allow" name="agreement1" value="">이용약관과 개인정보취급방침에 동의합니다.</label></p>

				<p style="text-align:center; margin-bottom:20px"><a type="button" onclick="join02();"><img src="../images/btn01.gif" /></a>&nbsp;&nbsp;<a href="#"><img src="../images/btn02.gif" /></a></p>
 ...
 <script>
 	function join02(){
 		var checkbox = document.getElementById("allow");
 		if(checkbox.checked == false)	{ alert('필수약관에 동의가 필요합니다.');	}
 		else							{ location.href="join02.jsp";				}
 	}
 </script>
</html>
