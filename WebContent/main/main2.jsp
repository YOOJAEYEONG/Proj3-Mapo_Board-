							...
							<tr>
								<td>
									...
									<p style="text-align: right; padding-right: 10px;">
										...
										<!--회원정보수정-->
										<a href="Logout.do"><img src="../images/login_btn05.gif" /></a>
										<!--로그아웃-->
									</p>
								</td>
							</tr>
			...
			<div class="main_con_center">
				<p class="main_title">
					<img src="../images/main_title02.gif" alt="공지사항 NOTICE" /><a
						href="../space/sub01.jsp?boardname=admin"><img
				...
				<ul class="main_board_list">
					...
					<li>
						<p
							...
							<a
								href="../space/sub01_view.jsp?boardname=admin&num=<%=dto.getNum()%>">
								<%=dto.getTitle()%></a> <span><%=newdate%></span>
						</p>
					</li>
					<%
						}
			...
			<div class="main_con_right">
				<p class="main_title">
					<img src="../images/main_title03.gif" alt="자유게시판 FREE BOARD" /><a
						href="../space/sub03.jsp?boardname=freeboard"><img
						src="../images/more.gif" alt="more" class="more_btn" /></a>
				</p>
				<ul class="main_board_list">
					<%
					...
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							...
							<td><img src="../images/cal_a01.gif"
								style="margin-top: 3px; cursor: pointer;" id="month_prev" /></td>
							<!-- 연월일 이미지 -->
							<td style="font-weight: bold; font-size: 24px;"
								id="calendar_n_view">2020년 6월</td>
							<!-- 다음달  -->
							<td><img src="../images/cal_a02.gif"
								style="margin-top: 3px; cursor: pointer;" id="month_next" /></td>
						</tr>
					</table>
				</div>
			...
			<div class="main_con_right">
				<p class="main_title">
					<img src="../images/main_title06.gif" alt="사진게시판 PHOTO BOARD" /><a
						href="../space/sub01_list.jsp?boardname=gallery"><img
						src="../images/more.gif" alt="more" class="more_btn" /></a>
				</p>
					...
					<li>
						<%
							for (int td = 0; td <= 1; td++) {
										...
										String src = "../space/sub01_view.jsp?boardname=gallery&num="
												+ bbsGallery.get(idx).getNum();
						%>
						<dl style="cursor: pointer; max-width: 90px; max-height: 80px;">
							<dt onclick="location.href='<%=src%>'"
								style="
							...
							<dd style="text-align: center;">
								<a
									href="../space/sub01_view.jsp?num=<%=bbsGallery.get(idx).getNum()%>"><%=bbsGallery.get(idx).getTitle()%></a>
							</dd>
						</dl> <%
