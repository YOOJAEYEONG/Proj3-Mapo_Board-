	...
	<div id="wrap" align="center">
		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<div>
					<c:if test="${USER_GRADE ne '일반' && USER_GRADE ne '관리자'}">
						 <div style="width: 100%; height: 110px;background-color: #D5CEC4; 
						 	border-radius: 5px; text-align: center; align-items: baseline; 
						 	font-weight: bold; font-size: 1.5em; padding-top: 2em; ">회원전용 공간입니다.</div>
					</c:if>
					<!-- 게시판 -->	
					<c:if test="${USER_GRADE eq '일반' || USER_GRADE eq '관리자'}">
